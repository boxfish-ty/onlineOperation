Ext.define('onlineOperation.coursePermission.view.PublicController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.coursePermissionPublic',
    require:[
    ...
    onAddFilter:function(){
        var coursePermiss_AddFilter  = (Ext.ComponentQuery.query('[itemId=coursePermiss_AddFilter]')[0]);
        var addFilterBtn             = (Ext.ComponentQuery.query('[itemId=addFilterBtn]')[0]);
        var collapsing               = coursePermiss_AddFilter.micro;

        coursePermiss_AddFilter.animate({dynamic: true,to: {height:collapsing?100:50}});
        coursePermiss_AddFilter.micro=(collapsing?false:true);
  ...
  onInit:function(container, eOpts){
      ...
      var authorizeBtn = this.lookupReference('authorizeBtn');

      grid.setWidth(w);
      grid.setHeight(h);
      authorizeBtn.setMargin( '0 0 0 '+(w-95));
  }
