Ext.define('onlineOperation.coursePermission.view.OtherController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.coursePermissionOther',
    require:[
    ...
    onAddFilter:function(){
        var coursePermissAddFilter  = (Ext.ComponentQuery.query('[itemId=coursePermissAddFilter]')[0]);
        var addFilterBtn            = (Ext.ComponentQuery.query('[itemId=addFilterBtn]')[0]);
        var collapsing              = coursePermissAddFilter.micro;

        coursePermissAddFilter.animate({dynamic: true,to: {height:collapsing?100:50}});
        coursePermissAddFilter.micro=(collapsing?false:true);
  ...
  onEnter:function(field,e){
    ...
    // },
      ...
      onInit:function(container, eOpts){
          ...
          var grid          = this.lookupReference('trainAppOtherGrid');
          var authorize_Btn = this.lookupReference('authorize_Btn');

          grid.setWidth(w);
          grid.setHeight(h);
          authorize_Btn.setMargin( '0 0 0 '+(w-95)+'' );
      }
