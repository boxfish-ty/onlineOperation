Ext.define('onlineOperation.trainCourse.view.PublicController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.trainCoursePublic',
    require:[
  ...
  onInit:function(container, eOpts){
      ...
      var grid  = this.lookupReference('trainCoursePublicGrid');
      var batch = this.lookupReference('coursePublicBatch');

      grid.setWidth(w);
      grid.setHeight(h);
      batch.setMargin( '0 0 0 '+(w-180));
  }
