Ext.define('onlineOperation.trainCourse.view.OtherController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.trainCourseOther',
    require:[
  ...
  onEnter:function(field,e){
    ...
    // },
      ...
      onInit:function(container, eOpts){
          ...
          var grid = this.lookupReference('trainCourseOtherGrid');
          var batch = this.lookupReference('courseOtherBatch');
