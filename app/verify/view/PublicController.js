Ext.define('onlineOperation.verify.view.PublicController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.public',
    require:[
  ...
  onInit:function(container, eOpts){
      ...
      var grid          = this.lookupReference('verifyGrid');
      var verifyDetails = this.lookupReference('verifyDetails');
      var verifyForm    = this.lookupReference('verifyForm');
      var batchButton   = this.lookupReference('batchButton');
      var reasonArea    = this.lookupReference('reasonArea');

      grid.setWidth(w);
      grid.setHeight(h);
      verifyDetails.setWidth((document.body.scrollWidth-w-80));
      verifyDetails.setHeight((h+36));
      verifyForm.setWidth( document.body.scrollWidth-w-90);
      batchButton.setMargin( '0 0 0 '+(w-70)+'' );
      reasonArea.setWidth(document.body.scrollWidth-w-90);
  }
